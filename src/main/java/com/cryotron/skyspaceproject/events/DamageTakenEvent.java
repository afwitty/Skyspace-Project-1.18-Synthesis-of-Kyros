...
<<<<<<< Updated upstream
	public static void DamageEvent(LivingDamageEvent event )  {
		...
		if ( entity.getAttribute(SkyspaceRegistration.ENERGY_SHIELD.get()) != null ) {
			Skyspace.LOGGER.info("Damaged Entity has Energy Shield of... " + entity.getAttributeValue(ENERGY_SHIELD));
