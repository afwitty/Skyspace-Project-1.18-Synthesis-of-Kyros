	...
	public KyrosianArchon(EntityType<? extends Monster> p_33002_, Level p_33003_) {
		...
		private AnimationFactory factory = new AnimationFactory(this);
		 ...
		 private <E extends IAnimatable> PlayState animationPredicate(AnimationEvent<E> event) {
	         event.getController().setAnimation(new AnimationBuilder().addAnimation("animation.archon.idle", true));
	     ...
	     {
	        data.addAnimationController(new AnimationController<KyrosianArchon>(this, "controller", 0, this::animationPredicate));
	     }
