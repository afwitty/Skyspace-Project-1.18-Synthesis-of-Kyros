...
public class StructurePieceCountsManager extends SimpleJsonResourceReloadListener {
    ...
    private List<StructurePieceCountsObj> getStructurePieceCountsObjs(JsonElement jsonElement) throws Exception {
        ...
        for(int i = piecesSpawnCounts.size() - 1; i >= 0; i--) {
            ...
            if(entry.condition != null) {
                ...
                () -> Skyspace.LOGGER.error("Error: Found " + entry.nbtPieceName + " entry has a condition that does not exist."));
            }
        }
    ...
    protected void apply(Map<ResourceLocation, JsonElement> loader, ResourceManager manager, ProfilerFiller profiler) {
        ...
        StructurePieceCountsAdditionsMerger.performCountsAdditionsDetectionAndMerger(manager); //.performCountsAdditionsDetectionAndMerger(manager);
    }
