    ...
    implements Versioned
{
     ...
     * (see {@link software.bernie.shadowed.fasterxml.jackson.databind.MapperFeature#IGNORE_DUPLICATE_MODULE_REGISTRATIONS})
    ...
    public static interface SetupContext
    {
        ...
        /**
         * Method that module can use to register additional
         * {@link TypeModifier} instance, which can augment {@link software.bernie.shadowed.fasterxml.jackson.databind.JavaType}
         * instances constructed by {@link software.bernie.shadowed.fasterxml.jackson.databind.type.TypeFactory}.
         * 
        ...
        /**
         * Method that module can use to register additional {@link software.bernie.shadowed.fasterxml.jackson.databind.deser.ValueInstantiator}s,
         * by adding {@link ValueInstantiators} object that gets called when 
         * instantatiator is needed by a deserializer.
         * 
         * @param instantiators Object that can provide {@link software.bernie.shadowed.fasterxml.jackson.databind.deser.ValueInstantiator}s for
