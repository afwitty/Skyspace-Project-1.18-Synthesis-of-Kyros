...
import software.bernie.shadowed.fasterxml.jackson.databind.ser.BeanSerializer;
import software.bernie.shadowed.fasterxml.jackson.databind.ser.ContextualSerializer;

/**
 * Serializer class that can serialize Object that have a
 * {@link software.bernie.shadowed.fasterxml.jackson.annotation.JsonValue} annotation to
    ...
    implements ContextualSerializer, JsonFormatVisitable, SchemaAware
{
     ...
     *    {@link software.bernie.shadowed.fasterxml.jackson.databind.annotation.JsonSerialize#using}), otherwise
     *    null
     */
...
//            TypeSerializer typeSer = new TypeSerializerWrapper(typeSer0, bean);
        ...
        throws JsonMappingException
    {
        ...
        return software.bernie.shadowed.fasterxml.jackson.databind.jsonschema.JsonSchema.getDefaultSchemaNode();
    }
