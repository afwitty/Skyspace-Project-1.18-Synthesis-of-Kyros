...
import software.bernie.shadowed.fasterxml.jackson.annotation.*;
...
import software.bernie.shadowed.fasterxml.jackson.core.util.*;
...
import software.bernie.shadowed.fasterxml.jackson.databind.jsontype.*;
...
import software.bernie.shadowed.fasterxml.jackson.databind.node.*;
import software.bernie.shadowed.fasterxml.jackson.databind.ser.*;
import software.bernie.shadowed.fasterxml.jackson.databind.type.*;
...
<pre>
  ...
  // and find values by, for example, using a {@link software.bernie.shadowed.fasterxml.jackson.core.JsonPointer} expression:
...
//            TypeFactory.defaultInstance().constructType(JsonNode.class);
    ...
    public Version version() {
        return software.bernie.shadowed.fasterxml.jackson.databind.cfg.PackageVersion.VERSION;
    }
    ...
    */
     ...
     * have a look at {@link software.bernie.shadowed.fasterxml.jackson.databind.introspect.AnnotationIntrospectorPair}.
     * 
     * @see software.bernie.shadowed.fasterxml.jackson.databind.introspect.AnnotationIntrospectorPair
     */
     ...
     * have been annotated with {@link software.bernie.shadowed.fasterxml.jackson.annotation.JsonTypeInfo}).
     *<P>
     ...
     * {@link software.bernie.shadowed.fasterxml.jackson.annotation.JsonTypeInfo}) will have
    ...
    /**
     * Method for changing state of specified {@link software.bernie.shadowed.fasterxml.jackson.core.JsonParser.Feature}s
    ...
    /**
     * Method for enabling specified {@link software.bernie.shadowed.fasterxml.jackson.core.JsonParser.Feature}s
     * for parser instances this object mapper creates.
     *<p>
    ...
    /**
     * Method for disabling specified {@link software.bernie.shadowed.fasterxml.jackson.core.JsonParser.Feature}s
     * for parser instances this object mapper creates.
     *<p>
     * Note that this is equivalent to directly calling same method on {@link #getFactory}.
     *
    ...
    /**
     * Method for enabling specified {@link software.bernie.shadowed.fasterxml.jackson.core.JsonGenerator.Feature}s
     * for parser instances this object mapper creates.
     *<p>
     * Note that this is equivalent to directly calling same method on {@link #getFactory}.
     *
    ...
    /**
     * Method for disabling specified {@link software.bernie.shadowed.fasterxml.jackson.core.JsonGenerator.Feature}s
     * for parser instances this object mapper creates.
     *<p>
     * Note that this is equivalent to directly calling same method on {@link #getFactory}.
     *
     ...
     * raw value ({@link software.bernie.shadowed.fasterxml.jackson.databind.util.RawValue}) or basic
     ...
     *  {@link software.bernie.shadowed.fasterxml.jackson.databind.node.ObjectNode}
...
//    	_setupClassLoaderForDeserialization(valueType);
     ...
     */
    @Deprecated
    public software.bernie.shadowed.fasterxml.jackson.databind.jsonschema.JsonSchema generateJsonSchema(Class<?> t)
