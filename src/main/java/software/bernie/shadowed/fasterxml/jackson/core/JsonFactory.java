...
import software.bernie.shadowed.fasterxml.jackson.core.io.*;
import software.bernie.shadowed.fasterxml.jackson.core.json.*;
        ...
        java.io.Serializable // since 2.1 (for Android, mostly)
{
     ...
     * if (and only if) {@link software.bernie.shadowed.fasterxml.jackson.core.JsonParser.Feature#AUTO_CLOSE_SOURCE}
     * is enabled.
     *<p>
     *
     ...
     * feature,
     * {@link software.bernie.shadowed.fasterxml.jackson.core.JsonGenerator.Feature#AUTO_CLOSE_TARGET}
     * is enabled).
     ...
     * {@link JsonGenerator#close} is called (unless auto-closing
     * feature,
     * {@link software.bernie.shadowed.fasterxml.jackson.core.JsonGenerator.Feature#AUTO_CLOSE_TARGET} is enabled).
