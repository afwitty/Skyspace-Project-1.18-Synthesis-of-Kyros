    ...
    implements java.io.Serializable // since 2.1; only because ObjectWriter needs it
{
    ...
    public software.bernie.shadowed.fasterxml.jackson.databind.jsonschema.JsonSchema generateJsonSchema(Class<?> type)
        throws JsonMappingException
    {
        ...
        JsonNode schemaNode = (ser instanceof SchemaAware) ?
                ((SchemaAware) ser).getSchema(this, null) : software.bernie.shadowed.fasterxml.jackson.databind.jsonschema.JsonSchema.getDefaultSchemaNode();
        if (!(schemaNode instanceof ObjectNode)) {
            throw new IllegalArgumentException("Class " + type.getName()
                    +" would not be serialized as a JSON object and therefore has no schema");
        }
        return new software.bernie.shadowed.fasterxml.jackson.databind.jsonschema.JsonSchema((ObjectNode) schemaNode);
    }
