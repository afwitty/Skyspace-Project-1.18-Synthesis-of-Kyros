 ...
 * annotations (like {@link software.bernie.shadowed.fasterxml.jackson.annotation.JsonTypeInfo} or JAXB annotations),
...
public interface TypeResolverBuilder<T extends TypeResolverBuilder<T>>
{
     ...
     * defaults for {@link software.bernie.shadowed.fasterxml.jackson.annotation.JsonTypeInfo.Id} configured.
     * 
     ...
     * {@link software.bernie.shadowed.fasterxml.jackson.databind.JsonDeserializer}s or not.
     * 
     * @return Resulting builder instance (usually this builder,
     *   but may be a newly constructed instance for immutable builders}
     * 
