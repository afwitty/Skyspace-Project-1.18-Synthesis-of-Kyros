 ...
 * {@link software.bernie.shadowed.fasterxml.jackson.core.JsonGenerator#writeRawValue(String)}.
 * It may be stored in {@link TokenBuffer}, as well as in Tree Model
 * ({@link software.bernie.shadowed.fasterxml.jackson.databind.JsonNode})
 * 
 * @since 2.6
 */
