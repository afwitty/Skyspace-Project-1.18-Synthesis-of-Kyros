...
//        return Collections.emptyIterator();
    ...
    /**
     * @deprecated Since 2.6, use method in {@link software.bernie.shadowed.fasterxml.jackson.databind.type.TypeFactory}.
     */
    @Deprecated
    ...
    public static boolean isBogusClass(Class<?> cls) {
        return (cls == Void.class || cls == Void.TYPE
                || cls == software.bernie.shadowed.fasterxml.jackson.databind.annotation.NoClass.class);
    }
